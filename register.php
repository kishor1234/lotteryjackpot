        ...
        <div class="wrapper fadeInDown">
            <div id="formContent">
                ...
                <div class="fadeIn first">
                    <img src="https://image.freepik.com/free-vector/jackpot-casino-banner_2967-872.jpg" id="icon" alt="User Icon" />
                </div>
                ...
                <!-- Remind Passowrd -->
                <div id="formFooter">
                    Already have a account<a class="underlineHover" href="index.php"> &nbsp; Login</a>
                </div>
